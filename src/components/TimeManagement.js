...
const TimeManagement = () => {
  ...
  return (
    <div className='bg-[#e3dce7]  rounded-xl px-3 py-4 flex flex-col gap-8'>
      <h3 className='text-2xl text-primary-purple font-bold text-center '>Time Management</h3>
      {loading ? ( // Show loading state
        <p className='text-primary-purple'>Loading events...</p>
      ) : (
        <Calendar
